...
--     	    name = "alien-goo",
-- 	    tint = COLOR_GOO,
-- 	    icon = "__RampantIndustry__/graphics/icons/goo.png"
--     })
--     alienGooBlueName = addFluid({
--     	    name = "alien-goo-blue",
-- 	    tint = COLOR_BLUE_GOO,
-- 	    icon = "__RampantIndustry__/graphics/icons/blue-goo.png"
--     })
--     alienGooRedName = addFluid({
--     	    name = "alien-goo-red",
-- 	    tint = COLOR_RED_GOO,
-- 	    icon = "__RampantIndustry__/graphics/icons/red-goo.png"
--     })
--     alienGooGreenName = addFluid({
--     	    name = "alien-goo-green",
-- 	    tint = COLOR_GREEN_GOO,
-- 	    icon = "__RampantIndustry__/graphics/icons/green-goo.png"
--     })
--     alienGooOrangeName = addFluid({
--     	    name = "alien-goo-orange",
-- 	    tint = COLOR_ORANGE_GOO,
-- 	    icon = "__RampantIndustry__/graphics/icons/orange-goo.png"
--     })
--     alienGooPurpleName = addFluid({
--     	    name = "alien-goo-purple",
-- 	    tint = COLOR_PURPLE_GOO,
-- 	    icon = "__RampantIndustry__/graphics/icons/purple-goo.png"
--     })
--     alienGooYellowName = addFluid({
--     	    name = "alien-goo-yellow",
-- 	    tint = COLOR_YELLOW_GOO,
-- 	    icon = "__RampantIndustry__/graphics/icons/yellow-goo.png"
--     })  
-- end
